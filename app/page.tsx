...
export default function CatalogPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f9] antialiased text-gray-900 selection:bg-blue-950 selection:text-white" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
      ...
      {/* BANDEAU FLASH INFO - MIS EN NOIR AVEC LETTRES ESPACÉES */}
      ...
      <header className="bg-white border-b-2 border-gray-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          {/* NOM DE LA MARQUE - AJOUT DE TRACKING-WIDE POUR DÉCOLLER LES LETTRES */}
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none">
          {["Tous", "Ligue 1", "Liga", "Premier League", "Équipes Nationales"].map((league) => (
            <button
              ...
              className={`px-4 py-2.5 text-xs font-black uppercase rounded transition-all border-2 tracking-widest ${
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        {/* TITRE DE LA CATÉGORIE - LETTRES BIEN DÉCOLLÉES ICI AUSSI */}
        <div className="border-b-2 border-gray-300 pb-2 mb-6 flex items-center justify-between">
          <h2 className="text-xl md:text-2xl font-black uppercase tracking-wide text-gray-800 italic" style={{ fontFamily: 'Impact, "Arial Black", sans-serif' }}>

      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-blue-200 leading-relaxed">
              Le meilleur du maillot de foot au meilleur prix.
          ...
          {/* Liens rapides */}
          <div>
            <h4 className="font-black text-sm uppercase tracking-wider mb-4">Liens Rapides</h4>
            <ul className="space-y-2 text-sm text-blue-200">
              <li><a href="#" className="hover:text-white transition-colors">Nouveautes</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Promotions</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Tous les maillots</a></li>
          ...
          {/* Aide */}
          <div>
            <h4 className="font-black text-sm uppercase tracking-wider mb-4">Aide</h4>
            <ul className="space-y-2 text-sm text-blue-200">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-black text-sm uppercase tracking-wider mb-4">Contact</h4>
            <ul className="space-y-2 text-sm text-blue-200">
              <li>contact@elitefootballshop.fr</li>
        ...
        <div className="border-t border-white/10 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-blue-300">
            2026 EliteFootballShop. Tous droits reserves.
          </p>
